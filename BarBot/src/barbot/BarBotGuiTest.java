...
public class BarBotGuiTest extends javax.swing.JFrame {
    ...
    private void MakeDrinksButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
                    ...
                    for(int j = 0; j < 7; j++){
                        String[] aPart = partsOfRecipe[i].split(";");
                            if(aPart[0].equalsIgnoreCase(ingrediants[j])){
                                ...
                                *
                                */
                                motorThrdAry[i] = new MotorThread(this, motorpin[j],(long)(Float.parseFloat(aPart[1])/(1/motorCalc[j])),gpio,motor_IO[j]);
...
//                        IngOz6.setText("0.0");
    ...
    private void LessButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
        float oz;
    ...
    private void IngOz5ActionPerformed(java.awt.event.ActionEvent evt) {                                       
